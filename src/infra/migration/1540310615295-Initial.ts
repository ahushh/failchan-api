...
export class Initial1540310615295 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query('CREATE TABLE "post_references_post" ("postId_1" integer NOT NULL, "postId_2" integer NOT NULL, CONSTRAINT "PK_f17cb8a4625c6018b677677e4d7" PRIMARY KEY ("postId_1", "postId_2"))');
    ...
    await queryRunner.query('ALTER TABLE "post_references_post" ADD CONSTRAINT "FK_f2b15912fe66a5b4df971ce2471" FOREIGN KEY ("postId_1") REFERENCES "post"("id") ON DELETE CASCADE');
    await queryRunner.query('ALTER TABLE "post_references_post" ADD CONSTRAINT "FK_14b0a5cf0c4cf5b645206da9400" FOREIGN KEY ("postId_2") REFERENCES "post"("id") ON DELETE CASCADE');
  }

  public async down(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query('ALTER TABLE "post_references_post" DROP CONSTRAINT "FK_14b0a5cf0c4cf5b645206da9400"');
    await queryRunner.query('ALTER TABLE "post_references_post" DROP CONSTRAINT "FK_f2b15912fe66a5b4df971ce2471"');
    ...
    await queryRunner.query('DROP TABLE "post_references_post"');
